...
class CollapsibleSection(QWidget):
    def __init__(
        ...
        self.toggle_button.setStyleSheet("QToolButton {border: none; background-color: none;}")
        ...
        self.header_line.setSizePolicy(QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Maximum))

        self.content_area = QScrollArea(self)
        self.content_area.setStyleSheet("QScrollArea {border-top: none;}")
        self.content_area.setSizePolicy(QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed))
